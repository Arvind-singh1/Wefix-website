...
SECRET_KEY = 'django-insecure-v(eh%&cv1s=mc$ywr)&81@tc8fq7exa77gjf6=o$3r&w+4zvxm'
...
STATIC_ROOT=os.path.join(BASE_DIR,"newassets")
MEDIA_URL="/media/"
MEDIA_ROOT=os.path.join(BASE_DIR,"media")
# Default primary key field type
# https://docs.djangoproject.com/en/3.2/ref/settings/#default-auto-field
PAYPAL_RECEIVER_EMAIL = 'arvindsingh1473695@mail.com'
